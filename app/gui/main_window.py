...
class MainWindow(ctk.CTk):
    def __init__(self):
        ...
        self.title_frame = components.HeaderFrame(self, list_choices=self.algorithms, selected_ref=self.algorithm_selected, corner_radius=0, fg_color=(cf.BG_COLOR_LIGHT, cf.BG_COLOR_DARK))
        self.title_frame.place(relx=0, rely=0, relwidth=1, relheight=0.1, anchor="nw")
        self.input_output_frame = components.InputOutputFrame(self, corner_radius=0, fg_color=(cf.BG_COLOR_LIGHT, cf.BG_COLOR_DARK))
        self.input_output_frame.place(relx=0, rely=0.1, relwidth=1, relheight=0.7, anchor="nw")
        self.alphabet_frame = components.AlphabetFrame(self, list_choices=self.alphabets, selected_ref=self.alphabet_selected,corner_radius=0, fg_color=(cf.BG_COLOR_LIGHT, cf.BG_COLOR_DARK))
